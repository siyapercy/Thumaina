  ...
  const [state, setState] = React.useState([
    {
      ...
      time: "2h",
      text:
        "This is an Item I am Pawning. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nihil nisi,\
    ...
    <div className="show">
      {state.map((post) => (
        <div key={post.id} className="empty">
          <div className="show__post-Pawns">
          </div>
