...
const PostTypeCasual = () => {
  const [state, setState] = React.useState([
    
    {
      ...
      time: "2h",
      text:
        "Here is a Casual Post sit amet, consectetur adipisicing elit. Nihil nisi,\
    ...
    <div className="show">
      {state.map((post) => (
        <div key={post.id} className="empty">
          <div className="show__post-Casual">
          </div>
